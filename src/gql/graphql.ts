...
export type GetAccountNftsQuery = { __typename?: 'query_root', current_token_ownerships_v2: Array<{ __typename: 'current_token_ownerships_v2', owner_address: string, amount: any, current_token_data?: { __typename: 'current_token_datas_v2', collection_id: string, largest_property_version_v1?: any | null, description: string, token_name: string, token_data_id: string, token_standard: string, token_uri: string, current_collection?: { __typename: 'current_collections_v2', collection_id: string, collection_name: string, description: string, creator_address: string, uri: string } | null } | null }> };
...
export type GetCollectionDetailsQuery = { __typename?: 'query_root', current_collections_v2: Array<{ __typename: 'current_collections_v2', collection_id: string, collection_name: string, description: string, creator_address: string, uri: string, max_supply?: any | null, current_supply: any }> };
